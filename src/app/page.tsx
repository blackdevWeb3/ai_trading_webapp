      ...
      <main className="w-full">
        ...
        <div className="grid grid-cols-3 gap-7 mt-5">
            ...
            <div className="flex justify-between w-full mt-5">
              ...
              <div className="max-w-[438px] w-full bg-[#26292E] justify-start rounded-2xl px-7 py-9 flex flex-col gap-[16px]">
                ...
                <div className="flex items-center gap-4 ">
                  <div className="text-[16px] leading-[33px] font-normal text-[#ffffff] bg-[#61C4E15E] rounded-2xl px-2">Stop-Loss (2%)</div>
                  <div className="text-[16px] leading-[33px] font-normal text-[#ffffff] bg-[#61C4E15E] rounded-2xl px-2">Take-Profit (5%)</div>
                </div>
          ...
          <div className="flex flex-col justify-between">
            <div className="flex flex-col bg-[#26292E] rounded-2xl p-9">
              ...
              <div className="flex flex-col gap-[10px] mt-[19px]">
                <div className="flex">
                  <div className="text-[16px] font-normal text-[#FFFFFF] bg-[#61C4E15E] p-2.5 rounded-[10px]">Active Strategies (3)</div>
                </div>
                <div className="flex gap-2">
                  <div className="text-[16px] font-normal text-[#FFFFFF] bg-[#61C4E15E] p-2.5 rounded-[10px]">Risk Level</div>
                  <div className="text-[16px] font-normal text-[#FFFFFF] bg-[#1C1D1F] p-2.5 rounded-[10px]">Moderate</div>
                </div>
                <div className="flex gap-2">
                  <div className="text-[16px] font-normal text-[#FFFFFF] bg-[#61C4E15E] p-2.5 rounded-[10px]">Execution Mode</div>
                  <div className="text-[16px] font-normal text-[#FFFFFF] bg-[#1C1D1F] p-2.5 rounded-[10px]">Automated</div>
                </div>
              </div>
              <div className="text-[16px] font-normal mt-[28px] text-[#FFFFFF]">Success Rate</div>
              <ProgressComponent />
            </div>
            <div className="flex flex-col bg-[#26292E] rounded-2xl p-9 gap-3.5">
